...
modellist = ['cres000', 'cres090', 'cres180', 'cres270', 'dblsrc', 'disk', 'ecres000', 'ecres045', 'ecres090', 'ecres315', 'edisk', 'grmhd', 'point+disk', 'point_edisk', 'ring']
    ...
    if imager in ['Comrade', 'THEMIS']:
        ...
        for model in modellist:
            for day in daylist:
                ...
                for band in bands:
                    if imager == 'ehtim': inputdir = os.path.join(inputdir, f'{model}_{day}_{calib}-{band}')
